#7.6.1: Function stubs: Statistics.
#Define stubs for the functions get_user_num() and compute_avg(). Each stub should print 
#"FIXME: Finish function_name()" followed by a newline, and should return -1. Each stub must 
#also contain the function's parameters.
